...
export const normalizeSongData = (songInfo) => {
...
export const normalizeAlbumData = (albumInfo) => {
...
export const generateSyncId = (title, artists, duration) => {
...
export const generateSyncArtistId = (name) => {

				...
				<div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 p-8 shadow-2xl">
					...
					>
						<div className="relative">
							...
							<AlertTriangle className="w-20 h-20 text-red-400 relative z-10" strokeWidth={1.5} />
						</div>
					</motion.div>
					...
					<motion.div
						...
						className="space-y-3"
					>
						<p className="text-white/60 text-sm text-center mb-4">What you can try:</p>
						{getSuggestions().map((suggestion) => (
							...
							>
								...
								<span className="text-white/90 text-sm font-medium">{suggestion.text}</span>
							</motion.button>
						))}
					</motion.div>
						...
						>
							<details className="text-white/40 text-xs">
								...
								<div className="mt-2 space-y-1 font-mono">
									...
									{originalUrl && <div className="break-all">Original URL: {originalUrl}</div>}
								</div>
							</details>
						</motion.div>
					)}

		...
		<div className="relative min-h-screen w-full overflow-hidden bg-gray-950 font-sans text-white">
			<div className="absolute inset-0 z-0 overflow-hidden">
				...
				<div
					...
					style={{
						background:
							"radial-gradient(at 70% 20%, rgba(255, 107, 0, 0.4), transparent 60%), radial-gradient(at 30% 80%, rgba(255, 149, 0, 0.3), transparent 60%)",
					}}
				/>
				...
				<motion.div
					...
					style={{
						background:
							"radial-gradient(at 50% 50%, rgba(255, 193, 7, 0.2), transparent)",
					}}
				...
				>
					...
					<motion.div variants={itemVariants} className="text-center">
						...
						<p className="mt-2 text-sm text-white/80 md:text-xl">
							Share and enjoy your favorite music with friends on different
							services.
						</p>
					</motion.div>
					{/* Footer credits */}
					<motion.div
						...
						className="mt-6 border-t border-white/10 pt-4 text-xs text-white/70"
					>
						<div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
							<div className="flex items-center gap-2 text-white/80">
								...
								<span>+</span>
								<a
									className="ml-2 flex items-center gap-1 text-white/90"
							...
							<div className="flex items-center gap-2 text-white/80">
								...
								<a
									...
									href="https://github.com/sync-fm/web"
									target="_blank"
									rel="noreferrer noopener"
								>
									<SiGithub className="w-4 h-4" />
					...
					>
						<motion.div
							...
							className="rounded-full bg-white/10 p-2 shadow-inner"
						>
							<SiSpotify
								className="w-8 h-8 text-green-500 drop-shadow-lg"
								title="Spotify"
							/>
						</motion.div>
						<motion.div
						...
						>
							<SiApplemusic
								className="w-8 h-8 text-shadow-gray-200 drop-shadow-lg"
								title="Apple Music"
							/>
						</motion.div>
						<motion.div
						...
						>
							<SiYoutubemusic
								className="w-8 h-8 text-red-400 drop-shadow-lg"
								title="YouTube Music"
							/>
						</motion.div>
					</motion.div>
					...
					<motion.div
						variants={itemVariants}
						className="mt-8 rounded-2xl bg-white/3 p-4 text-left text-sm text-white/85 shadow-inner"
					>
						<h2 className="text-lg font-semibold">How SyncFM links work</h2>
						<p className="mt-2 text-white/70">
							Paste any streaming URL and SyncFM will create an easy redirect.
							The behaviour depends on the subdomain used before{" "}
							<strong>syncfm.dev</strong>:
						</p>
						<ul className="mt-3 ml-4 list-disc text-white/65">
							<li className="mt-1">
								<strong>s.syncfm.dev/&lt;url&gt;</strong> - converts and
								redirects directly to Spotify.
							</li>
							<li className="mt-1">
								<strong>am.syncfm.dev/&lt;url&gt;</strong> - converts and
								redirects directly to Apple Music.
							</li>
							<li className="mt-1">
								<strong>yt.syncfm.dev/&lt;url&gt;</strong> - converts and
								redirects directly to YouTube Music.
							</li>
							<li className="mt-1">
								<strong>syncfm.dev/&lt;url&gt;</strong> (no subdomain) - opens
								the SyncFM Share UI where the visitor can pick which service to
								open the link with.
							</li>
						</ul>
						...
						<ul className="mt-2 ml-4 list-disc text-white/65">
							<li>
								&quot;&lt;url&gt;&quot; can be any supported streaming link -
								for example{" "}
								<span className="font-mono break-words whitespace-normal max-w-full block">
									https://open.spotify.com/track/1hSiinjZSwghTo3zeoGPOa
								</span>
							</li>
						</ul>
						...
						<div className="mt-2 w-full max-w-md rounded-lg bg-white/5 p-3 text-sm text-white/80 space-y-3">
							<div>
								...
								<div className="rounded-md bg-white/6 p-2 font-mono text-sm break-words">
									https://open.spotify.com/track/1hSiinjZSwghTo3zeoGPOa
								</div>
							</div>
							<div>
								<div className="mb-1 text-xs text-white/60">
									Short host-style link (service specific)
								</div>
								<div className="rounded-md bg-white/6 p-2 font-mono text-sm break-words">
									am.syncfm.dev/https%3A%2F%2Fopen.spotify.com%2Ftrack%2F1hSiinjZSwghTo3zeoGPOa
								</div>
							</div>
							<div>
								<div className="mb-1 text-xs text-white/60">
									Short host-style link (opens Share UI)
								</div>
								<div className="rounded-md bg-white/6 p-2 font-mono text-sm break-words">
									syncfm.dev/https%3A%2F%2Fopen.spotify.com%2Ftrack%2F1hSiinjZSwghTo3zeoGPOa
								</div>
							</div>
						</div>
					</motion.div>
